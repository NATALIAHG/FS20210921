...
import { blogViewModelService, RESTDAOService } from './servicios.service';
...
//     service.delete(4)
//     dao.query().subscribe((data: string | any[]) => expect(data.length).toBe(4))
//     tick()
//   }))
...
//     service.send()
//     tick()
//     dao.query().subscribe((data: string | any[]) => expect(data.length).toBe(5))
//     dao.get(5).subscribe((data: { nombre: any; }) => expect(data.nombre).toBe(NOMBRE))
//     tick()
...
function NavigationService(NavigationService: any) {
