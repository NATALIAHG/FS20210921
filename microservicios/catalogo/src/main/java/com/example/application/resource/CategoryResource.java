...
public class CategoryResource {
	...
	public Page<Category> getAllPageable(Pageable item) {
		return srv.getByProjection(item, Category.class);
	}*/
	...
	public List<FilmShort> getPelis(@PathVariable int id) throws NotFoundException {
		...
		if(Category.isEmpty())
			...
			return (List<FilmShort>) Category.get().getFilmCategorys().stream().map(item -> FilmShort.from(item)).collect(Collectors.toList());
		}
	} */
